class Poll < ApplicationRecord
  ...
  ACCESS_LEVEL = { level_3: 3, level_4: 4 }
  ...
  # Valida si el usuario tiene permisos para poder votar.
  # Se necesita haber accedido con un nivel igual o superior al definidio en la botación: DNIe (nivel 4) o certificado electrónico (nivel 3), etc.
  def validate_permission(current_user)
    #debugger
    if self.access_level <=  current_user.level_login
      return true
    else
      return false
    end
